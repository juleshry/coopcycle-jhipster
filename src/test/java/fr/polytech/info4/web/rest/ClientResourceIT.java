...
class ClientResourceIT {
    ...
    public static Client createEntity(EntityManager em) {
        Client client = new Client().name(DEFAULT_NAME).surname(DEFAULT_SURNAME).address(DEFAULT_ADDRESS).phone(DEFAULT_PHONE);
        return client;
    }
    ...
    public static Client createUpdatedEntity(EntityManager em) {
        Client client = new Client().name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
        return client;
    }
    ...
    void putNewClient() throws Exception {
        ...
        updatedClient.name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    ...
    void partialUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
    ...
    void fullUpdateClientWithPatch() throws Exception {
        ...
        partialUpdatedClient.name(UPDATED_NAME).surname(UPDATED_SURNAME).address(UPDATED_ADDRESS).phone(UPDATED_PHONE);
